  ...
  return (
    <div className='bg-secondary-1 max-w-screen-2xl relative mx-auto flex flex-col gap-4 text-center justify-center text-tertiary-1 md:p-20 px-8 py-20'>
      ...
      <div className='flex md:flex-row flex-col gap-6 items-center'>
        <img className='max-w-sm sm:mx-auto md:ml-auto md:mr-0' src={aboutImage}/>
        ...
        <div className='md:text-left basis-1/2 flex flex-col gap-2'>
          ...
          <p className='text-secondary-2 text-sm leading-6 font-light font-display'> 
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate molestias, doloribus quae in impedit eum placeat debitis, maiores explicabo id sed quod esse quidem at eveniet? Veritatis, dolores. Deleniti impedit veniam recusandae dolores, nostrum obcaecati!
          </p>
