...
const Navbar = () => {
  return (
    <nav className='absolute left-1/2 -translate-x-1/2 w-full max-w-screen-2xl md:py-10 py-4 px-8 md:px-20 flex items-center justify-between bg-transparent dark:bg-secondary-1 text-secondary-1 dark:text-tertiary-1'>
      ...
      <ul className='md:flex hidden items-center gap-0 font-display font-light ml-auto'>
        ...
        <li><a className='hover:bg-green-400 text-sm bg-primary-1 hover:bg-primary-2 hover:border-primary-2 hover:text-tertiary-1 text-tertiary-1 py-2 px-5' href='./Contact'>Contact Me</a></li>
      </ul>
